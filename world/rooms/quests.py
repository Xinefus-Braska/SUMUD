...
class SUQuestHandler:
    ...
    quest_storage_attribute_category = "SU"

    quest_data_attribute_template = "_quest_data_{quest_key}"
    quest_data_attribute_category = "SU"
    ...
    def get(self, quest_key):
        ...
        Returns:
            SUQuest or None: The quest stored, or None if
    ...
    def add(self, quest_class):
        ...
        Args:
            quest_class (SUQuest): The quest class to start.
