...
class CmdRift(MuxCommand):
    """
    Open the Rift menu to access the Rift system.
    """
    key = "rift"
    locks = "cmd:all()"
    ...
    def func(self):
        ...
        if caller.has_account:  # Ensure the object is a player character
            caller.msg("You feel the chaotic energy of the Rift swirling around you.")
            self.start_menu(caller)
                ...
                if dungeon_manager:
                    ...
                    if dungeon_manager.check_dungeon(caller.name, sub_dungeon):
                        ...
                        dungeon = dungeon_manager.generate_dungeon(
                            ...
                            creator=caller.name,
                            connecting_room=self.caller.location,
                        )
